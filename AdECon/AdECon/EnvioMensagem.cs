...
namespace AdECon
{
    public class EnvioMensagem
    {
        ...
        public static void EnvioSmsDev(Morador morador)
        {
            ...
            string sMsg = string.Concat("&msg=Cond. Residencial Aricanduva: Olá ", morador.NomeDestinatario, " Seu Sedex 'Camisa do TIMÃO' chegou e já está disponível para retirada na Adm até as 18 horas!");
